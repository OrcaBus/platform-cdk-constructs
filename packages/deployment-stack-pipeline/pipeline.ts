...
import { betaEnvironment, gammaEnvironment, prodEnvironment } from "./config";
...
export interface DeploymentStackPipelineProps {
  ...
  /**
   * The github repository name e.g. `umccr/micro-service`
   */
...
class DeploymentStage extends Stage {
  constructor(
    ...
    new stackClass(this, "ApplicationStack", {
      env: env,
      tags: {
